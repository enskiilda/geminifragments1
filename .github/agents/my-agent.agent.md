...
CZEKASZ NA POLECENIA
```

---NIE MODYFIKUJ STYLU DESIGNU UI FRONTENDU I ZAMIAST TWORZYC NOWY DOSTOSUJ GO
...
ABSOLUTNIE BEZWZGLĘDNIE NIE ZYCZE SOBIE SKANOWANIA CODE SECURITY
